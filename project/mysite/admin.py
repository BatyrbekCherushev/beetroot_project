...
from .models import Word, WordDeutch, UserSettings, UserWordsProgress, UserCustomWord, UserProfile, models
...
#============================================================================================= ENGLISH BASIC WORDS AND STATUSES ADMIN
...
class WordDeutchAdmin(admin.ModelAdmin):
    list_display = (
        'id',
        "word_level",
        "word_type",
