from app_site.models import UserCustomWord, Word, WordDeutch, UserWordsProgress, UserWordsDeutchProgress, User, UserSettings, WordCategory, WordSubcategory, PlayerProfile, Battle, BossProfile, Skill, PlayerSkill, BossSkill, BattleTurn, BattleRound
...
def arena_page(request):
    return render(request, 'app_site/arena.html', context = {
        'app_name': 'app_site',
        'page_name': 'arena',
